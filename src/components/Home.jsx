...
//     "mdkrtf adalah tim kreatif yang penuh semangat, didorong oleh visi bersama untuk menciptakan identitas merek yang menarik.";
  ...
  useEffect(() => {
    ...
    mm.add("(min-width: 1024px)", () => {
      gsap.to(".sideWrap", {
        duration: 180, // Memperpanjang durasi untuk animasi yang lebih lambat
        y: -8000,    // Mengatur pergerakan di sumbu Y lebih jauh
        x: 8000,    // Mengatur pergerakan di sumbu X lebih jauh
        repeat: -1,
        ease: "none",
      });
    });
    ...
    mm.add("(max-width: 1024px)", () => {
      gsap.to(".sideWrap", {
        duration: 180, // Sama seperti di atas, tapi bisa disesuaikan
        y: -8000,    // Sesuaikan jarak pada perangkat mobile
        x: 8000,    // Sesuaikan jarak pada perangkat mobile
        repeat: -1,
        ease: "none",
      });
    });
  ...
  return (
    <section id="hero" className="position-relative overflow-hidden" style={{ height: "630px" }}>
      ...
      <div className=" mt-5">
        ...
        <div className="wrapper font-weight-medium display-4" style={{fontFamily: "'Open Sans', sans-serif"}}>
