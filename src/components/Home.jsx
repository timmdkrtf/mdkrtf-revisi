...
//     "mdkrtf adalah tim kreatif yang penuh semangat, didorong oleh visi bersama untuk menciptakan identitas merek yang menarik.";
  const sideText =
    "CREATIVE DESIGN INNOVATION VISUAL IDENTITY BRANDING INTERACTIVE DESIGN CONCEPT CREATIVE DESIGN INNOVATION VISUAL IDENTITY CREATIVE BRANDING DESIGN INTERACTIVE CREATIVE CONCEPT DESIGN INNOVATION CREATIVE IDENTITY VISUAL BRANDING INTERACTIVE CREATIVE CONCEPT CREATIVE DESIGN INNOVATION VISUAL IDENTITY BRANDING DESI INTERACTIVE DESIGN CONCEPT CREATIVE DESIGN INNOVATION VISUAL IDENTITY BRANDING INTERACTIVE DESIGN CONCEPT CREATIVE DESIGN INNOVATION VISUAL IDENTITY BRANDING INTERACTIVE DESIGN CONCEPT";
      ...
      if (wordMarker.includes(word)) {
        return (
          <div key={index} className="overflow-hidden">
            <div className="splitWord fw-semibold fs-1 bg-light px-1" style={color.textPurple}>
              {word}
            </div>
          </div>
        );
